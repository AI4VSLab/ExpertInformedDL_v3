# -*- coding: utf-8 -*-
"""Cleaning Transcripts Multiple Captions.ipynb
...
for explanations in combined_df["VQA_Transcript"]:
    ...
    for explanation in explanations:
        ...
        input_ids_list.append(ids_np[0])
        attn_mask_list.append(mask_np[0])
...
for _, row in clean_df.iterrows():
   ...
   # clean_attn_mask = row["Cleaned_attn_mask"]
    ...
    if isinstance(image_data, bytes) and isinstance(class_label, str):
      ...
      '''
      VQA_record = {
          "input_ids": (np.array(VQA_input_ids, dtype=np.int64), "int"), #shape (8, max_len)
